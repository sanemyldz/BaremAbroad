        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialRef = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BlogArticles_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BlogArticles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentDetails_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserComments_BlogArticles_BlogArticleId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserComments_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCommentLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCommentLogs_UserComments_UserCommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogArticles_ProgramId",
                table: "BlogArticles",
                column: "ProgramId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentDetails_ProgramId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCommentLogs_UserCommentId",
                table: "UserCommentLogs",
                column: "UserCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserComments_BlogArticleId",
                table: "UserComments",
